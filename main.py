...
train_set = UserDataset(converter1, converter2, positive_rate=0.5)
loss_fcn = nn.BCEWithLogitsLoss()
optimizer = Adam(model.parameters(), lr=2e-4, betas=(0.5, 0.98))
train_loader = DataLoader(train_set, batch_size=64, shuffle=True, collate_fn=user_data_collate)
epochs = 5
